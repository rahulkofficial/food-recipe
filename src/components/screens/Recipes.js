...
export default function Recipes() {
  ...
  async function handleFavAdd(id){
    try{
      await axios.post(`${base_url}/api/v1/recipes/add_fav/${id}`,null,{
        headers: {
      ...
      const resps=await axios.get(`${base_url}/api/v1/recipes/fav`, {
            headers: {
              Authorization: `Bearer ${accessToken}`,
            },
            });
  ...
  async function handleFavRemove(id){
    try {
      await axios.delete(`${base_url}/api/v1/recipes/remove_fav/${id}`,{
        headers: {
          Authorization: `Bearer ${accessToken}`,
        },
      },
  ...
  const handleClick=(id)=>{
    window.location.href=`${origin}/recipe_detailed/${id}`;
  }
     ...
     document.title="Food Recipes | Recipes"
      async function fetchData(){
        try {
          ...
          const resp=await axios.get(`${base_url}/api/v1/recipes/categories`, {
            headers: {
              Authorization: `Bearer ${accessToken}`,
            },
          });
          ...
          const response=await axios.get(`${base_url}/api/v1/recipes/user`, {
          headers: {
            Authorization: `Bearer ${accessToken}`,
          },
          });
  ...
  return (
    <section className="all">
      <section className="wrapper">
          <header>
              <div>
                  <h1><a href="/recipes"><img src={require("../assets/images/logo.png")} alt="logo" /></a></h1>
                  ...
                  {myrecipes.length===0?(
                    fav?(
                      <>
                        ...
                        <>
                          <a href="/add" className="button">Add Recipes</a>
