...
export default function Add() {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
          const response=await axios.post(`${base_url}/api/v1/recipes/add`, {title:name,file:image,description:description,category:category}, {
          headers: {
            Authorization: `Bearer ${accessToken}`,
            ...
            <section className="wrapper">
                ...
                <form action="" method="post" id="recipeForm" encType="multipart/form-data" onSubmit={handleSubmit}>
                    ...
                    <span className="button">
                        ...
                        <a href="/recipes" className="button">Cancel</a>
                    </span>
                </form>
            </section>
        </section>
